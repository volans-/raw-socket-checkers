 ...
 *
 * Part:        check_http_raw header file.
 *
...
#ifndef _RSC_CHECK_HTTP_RAW_HEADER
# define _RSC_CHECK_HTTP_RAW_HEADER 1

/*
 * Parse command line arguments
 */
check_http_raw_arguments_type parse_args(int argc, char **argv);

/*
 * Perform an HTTP check using RAW or TCP socket based on the LB role.
 */
uint8_t http_check(check_http_raw_arguments_type *arguments);
